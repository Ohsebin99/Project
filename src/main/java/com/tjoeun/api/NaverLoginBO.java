...
//	네이버 로그인 API 등록시 발급받은 Client ID, Client Secret과 Callback URL을 입력한다.
	private final static String CLIENT_ID = "bcCriU073kkKK6U904EU";
	private final static String CLIENT_SECRET = "QXffTJK4xJ";
	private final static String REDIRECT_URI = "http://192.168.0.128:9876/meokjang/callback";	
