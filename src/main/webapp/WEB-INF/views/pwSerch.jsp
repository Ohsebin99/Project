			...
			<div class="col-lg-6 col-md-8 col-sm-12 col-xs-12">
				<form class="comment-form mb-3 gray-bg p-5" action="pwSerch" method="post" onsubmit="return passwordSerch()">
					...
					<div class="row">
						...
						<div class="col-lg-6">
							<input type="text" name="jumin1" maxlength="6" value="950504" placeholder="주민번호 앞자리" class="form-control mb-3"/>
						</div>
						<div class="col-lg-6">
							<input type="password" name="jumin2" maxlength="7"  placeholder="뒷자리" value="1057834" class="form-control mb-3"/>
						</div>
					</div>
					<div class="d-grid">
