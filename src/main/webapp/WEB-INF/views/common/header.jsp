...
<script type="text/javascript">window.mo = "${mo}";</script>
		...
		<div class="col-lg-6 col-md-12">
			<nav class="navbar navbar-expand-lg navigation-2 navigation">
	        	<div class="collapse navbar-collapse" id="navbar-collapse">
	            	<input type="hidden" id="loginCheck" value="${mo}"/>
	            	<ul id="menu" class="menu navbar-nav mx-auto">
	                    ...
	                    <li class="nav-item"><a href="admin"  class="nav-link" style="font-size: 20px;">adminPage</a></li>
	                </ul>
	        	</div>
			</nav>
		</div>
						...
						<div class="row">
							<span>
								...
								<a id="myProfile" href="myProfileChk">
									...
									%>
									    <!-- 일반 로그인 이미지 -->
									    <img src="upload/memberphoto/${mo.photo}" class="img-fluid w-100" style="height: 45px; width: 5px; border-radius: 50px;">
									<%
									} else if ("naver".equals(loginType)) {
									%>
									    <!-- 네이버 로그인 이미지 -->
									    <img src="https://ssl.pstatic.net/static/pwe/address/img_profile.png" class="img-fluid w-100" style="height: 45px; width: 5px; border-radius: 50px;">
									<%
									}
									%>
								</a>
							...
							<span class="text-center mr-3" style="font-size: 10pt; font-weight: bold; padding-top: 10px;">
								<a id="myProfile" href="myProfileChk"> ${mo.nickName}</a>
							</span>
